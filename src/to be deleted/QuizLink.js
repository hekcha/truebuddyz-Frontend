            ...
            <Card className={`text-center ${classes.cardBody}`}>
                ...
                <Card.Body>
                    ...
                    <Card.Title className={classes.title}>
                        <textarea
                            id="link"
                            value={`${process.env.REACT_APP_URL}/quiz/play/${props.code}`}
                            style={{
                                overflow:'hidden',
                                padding: "0vw 2vw",
                                marginBottom: "-20px",
                    ...
                    <span>
                        <a href={`${process.env.REACT_APP_URL}/quiz/view/${props.code}`}>
                            <button
                                type="button"
                        ...
                        <button
                            ...
                            data-mdb-ripple-color="dark"
                            style={{ marginTop: "18px", marginBottom: "-25px", borderRadius: "10px" }}
                            onClick={() => {copy(`${process.env.REACT_APP_URL}/quiz/play/${props.code}`);}}
                        >
                            Copy link🔗
                        </button>
                    </span>
                ...
                <Card.Footer className="text-muted p-3">
                    ...
                    >
                        <span className="sr-whatsapp sr-text-below">
                            <a href={`https://api.whatsapp.com/send?text=${process.env.REACT_APP_URL}/quiz/play/${props.code}`} target="_blank" title="WhatsApp">
                        ...
                        <span className="sr-telegram sr-text-below">
                            <a
                                href={`https://telegram.me/share/url?url=${process.env.REACT_APP_URL}/quiz/play/${props.code};text=Free%20Social%20Media%20Share%20Buttons%20Generator%20-%20Aakash%20Web`}
                                target="_blank"
                                title="Telegram"
                            >
                        ...
                        <span className="sr-facebook sr-text-below ">
                            <a href={`https://www.facebook.com/share.php?u=${process.env.REACT_APP_URL}/quiz/play/${props.code}`} title="Facebook">
