	...
	return (
		<div class="min-h-screen sm:p-10 p-5 lg:px-10 bg-gray-100">
			<div class="min-h-screen max-w-5xl mx-auto place-content-center justify-center justify-items-center grid md:grid-cols-2 lg:grid-cols-3 gap-x-14 gap-y-5">
				<div onClick={() => (window.location.href = "/rapidfire/friends")} class="bg-white shadow-lg rounded-xl overflow-hidden max-w-xs order-first lg:order-none">
					<div>
				...
				<div onClick={() => (window.location.href = "/rapidfire/bff")} class="bg-white shadow-lg rounded-xl overflow-hidden max-w-xs order-3 md:row-start-1 md:col-start-2 lg:order-none">
					<div>
				...
				<div onClick={() => (window.location.href = "/rapidfire/couples")} class="bg-white shadow-lg rounded-xl overflow-hidden max-w-xs order-5 lg:order-none">
					<div>
