...
function Playquiz(props){
    ...
    useEffect(()=>{
        ...
        }).then(resp=>resp.json()).then(res=> setQue(res[0]))
        ...
        if(i<10)
            return(
                <div>
                    ...
                    <br />
                    que{i} =   {que[`que${i+1}`]}<br />
                    <br />
                    <br />
                    <div className="row">
                        <div className="optionA col-6 d-flex justify-content-center" onClick={() => Checkans(1)} >
                            <img src={que[`img${i+1}A`]}></img>
                            <h4>{que[`option${i+1}A`]}</h4>
                        </div>

                        <div className="optionB col-6 d-flex justify-content-center" onClick={() => Checkans(2)} >
                            <img src={que[`img${i+1}B`]}></img>
                            <h4>{que[`option${i+1}B`]}</h4>
                        </div>

                        <div className="optionC col-6 d-flex justify-content-center" onClick={() => Checkans(3)} >
                            <img src={que[`img${i+1}C`]}></img>
                            <h4>{que[`option${i+1}C`]}</h4>
                        </div>

                        <div className="optionD col-6 d-flex justify-content-center" onClick={() => Checkans(4)} >
